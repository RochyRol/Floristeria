...
export default function ContactoPage() {
  return (
    <div style={{ background: BG, minHeight: "100vh", paddingTop: 72 }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px" style={{ border: `1px solid ${B}`, background: B }}>
          {contactMethods.map((c) => (
            <a
              ...
              style={{ background: BG, padding: "28px 24px", textDecoration: "none", transition: "background 0.25s" }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-px" style={{ border: `1px solid ${B}`, background: B }}>
          <div style={{ background: BG, padding: "32px 28px" }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span style={{ fontSize: 9, letterSpacing: "0.26em", textTransform: "uppercase", color: GOLD, fontFamily: "var(--font-manrope, sans-serif)" }}>
                Horarios
              </span>
            </div>
      ...
      <div className="max-w-8xl mx-auto px-6 lg:px-12 pb-20">
        <div style={{ border: `1px solid ${B}`, overflow: "hidden", position: "relative" }}>
          <div
            ...
            style={{ zIndex: 1, boxShadow: `inset 0 0 60px ${BG}44` }}
          />
          <iframe
            src={MAP_URL}
            width="100%"
      ...
      {/* ── WhatsApp CTA ── */}
      <div
        style={{ borderTop: `1px solid ${B}`, padding: "64px 24px", textAlign: "center", position: "relative", overflow: "hidden" }}
      >
        <div
          className="absolute inset-0 pointer-events-none"
          style={{ background: `radial-gradient(ellipse at center bottom, rgba(37,211,102,0.04) 0%, transparent 60%)` }}
        />
